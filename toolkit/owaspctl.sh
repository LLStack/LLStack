...
install_owasp(){
    ...
    if [ ! -f "/root/llstack-china-speed-tag.txt" ]; then
        curl -L --retry 3 -o "coreruleset-${crs_version}.zip" "https://github.com/coreruleset/coreruleset/archive/refs/tags/v${crs_version}.zip"
